...
FeatureList features =(FeatureList) GeneMarkGTFReader.read("/Users/admin/Dropbox/workspace/bio/testWT.gtf");
Iterator<FeatureI> featureIterator = features.iterator();
FeatureI rowWT = null;
FeatureList features1=(FeatureList) GeneMarkGTFReader.read("/Users/admin/Dropbox/workspace/bio/testKI.gtf");
...
String WTexonNumber= rowWT.getAttribute("exon_number");
	...
	//if(exonsa!=0)
				...
				//System.out.println("SplicingVariant:exon" +	WTRNAID+ " "+	WTexonNumber+ " "+KIexonNumber);
